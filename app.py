    ...
    if len(raw) > 1:
        ...
        with tab_sum:
            ...
            with c1:
                ...
                st.plotly_chart(px.bar(monthly_perf, x='Stay_Month', y='Room_Revenue', text_auto=',.0f', title="투숙월별 매출 점유"), use_container_width=True)
            with c2:
        ...
        with tab_det:
            st_net, st_bk, st_cn = st.tabs(["🏁 전체 합산", "✅ 신규 예약", "❌ 취소 내역"])
